...
<head>
    ...
    <title>Shippers | QuickMart</title>
...
<div class="main">
    <div class="topbar mb-4">
        <div>
            <h2>🚚 Shippers</h2>
            <p class="mb-0">Manage logistics providers and delivery courier channels</p>
        </div>
        ...
        <form id="form">
            <div class="modal-content" style="border-radius: 20px; overflow: hidden;">
                <div class="modal-header modal-header-pink">
                    <h5 class="modal-title" id="modalTitle">Shipper Form</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control" name="ShipperName" placeholder="e.g., Express Delivery Inc." required>
                    </div>
                    <div class="mb-2">
...
let table = $('#tbl').DataTable({
    ...
    columns: [
        ...
        { data: "Phone" },
        {
            ...
            render: function(d) {
                return `
                <button class="btn btn-warning btn-sm editBtn" style="border-radius:8px;" data-id="${d.ShipperID}">
                    <i class="bi bi-pencil"></i> Edit
                </button>
                <button class="btn btn-danger btn-sm deleteBtn" style="border-radius:8px;" data-id="${d.ShipperID}">
...
$(document).on('click', '.deleteBtn', function() {
    ...
    Swal.fire({
        ...
        text: "This removal could break orders historically handled by this provider!",
        icon: 'warning',
